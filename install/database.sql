...
/*!40000 DROP DATABASE IF EXISTS `dashboard`*/;
...
--
-- Table structure for table `pro3x_fiscal_requests`
--

DROP TABLE IF EXISTS `pro3x_fiscal_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pro3x_fiscal_requests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pro3x_fiscal_requests`
--

LOCK TABLES `pro3x_fiscal_requests` WRITE;
/*!40000 ALTER TABLE `pro3x_fiscal_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `pro3x_fiscal_requests` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pro3x_locations` (
  ...
  `iban` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `note1` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `pro3x_locations` VALUES (1,'Promijenite naziv lokacije',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `pro3x_templates` (
  ...
  `dueDays` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `pro3x_templates` VALUES (1,1,'Gotovina','gotovina','G',0,500,NULL,NULL,'',''),(2,1,'Ponuda','tender','P',0,100,NULL,NULL,'','');
...
-- Dump completed on 2025-12-27 15:56:34
