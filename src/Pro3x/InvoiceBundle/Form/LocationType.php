...
class LocationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
                ...
                ->add('note1', 'text', array('label' => 'Svi dokumenti', 'required' => false))
                ->add('note2', 'text', array('label' => 'Računi', 'required' => false))
                ->add('note3', 'text', array('label' => 'Ponude', 'required' => false))
